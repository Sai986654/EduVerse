                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="flex items-center gap-4 py-2 border-b border-slate-100 pb-4">
                      <div className="w-16 h-16 rounded-full bg-slate-100 border border-slate-200 overflow-hidden flex items-center justify-center relative shadow-inner shrink-0">
                        {avatarUrl ? (
                      ...
                      <div className="flex-1 space-y-1">
                        <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider block">Profile Photo</label>
                        <input 
                          type="file" 
                          accept="image/*" 
                        ...
                        <label 
                          ...
                          className="cursor-pointer inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-200 hover:bg-slate-50 transition-all text-xs font-bold text-slate-700 bg-white shadow-sm"
                        >
